class Characters::Stick1V2::AnimationStates::InAirRight < Character::State
  ...
  def initialize character
    ...
    @controller_states = ["InAirAttacksRight", "InAirNeutralRight", "InAirMovement", "InAirReactivesRight"]
  end
